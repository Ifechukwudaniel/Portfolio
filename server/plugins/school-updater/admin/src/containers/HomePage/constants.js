...
export const GET_DOC_INFOS_SUCCEEDED =
  "documentation/HomePage/GET_DOC_INFOS_SUCCEEDED";
...
export const ON_CONFIRM_DELETE_DOC =
  "documentation/HomePage/ON_CONFIRM_DELETE_DOC";
